...
const DEFAULT_GLOW_COLOR = '229, 217, 182';
...
const defaultCardData: BentoCardProps[] = [
  {
    ...
    description:
      "We bypass the noise of 'hype-driven' development to focus on architectural clarity and long-term scalability. Our approach emphasizes clean architecture, maintainability, and systems that grow with your business.",
    className:
  ...
  },
  {
    ...
    description:
      'Training custom ML models and building bespoke infrastructure from the ground up. We craft specialized solutions tailored to your unique requirements, not off-the-shelf templates.',
    className:
  ...
  },
  {
    title: 'Research-Led',
    description:
      'Collaborating with domain experts to ensure every line of code serves a verified human need. We validate assumptions through research and user feedback before building.',
    className:
  ...
  },
  {
    title: 'The Stack',
    description:
      'Leveraging Next.js, Python, and PostgreSQL to deliver high-performance digital systems. We combine proven technologies with modern practices to create robust, scalable solutions that perform at scale.',
    className:
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-4 p-6 w-full select-none relative"
